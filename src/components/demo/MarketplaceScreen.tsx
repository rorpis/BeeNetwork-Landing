  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-1">
        {/* Map section - Always takes most of the width */}
        <div className={`${showLocationDetails ? 'w-[70%]' : 'w-full'} h-[calc(100vh-64px)] relative`}>
        ...
        {/* Details panel - Only visible when a location is selected */}
        {showLocationDetails && (
          <div className="w-[30%] p-4 bg-background overflow-y-auto">
