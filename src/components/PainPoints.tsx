...
const PainPoints = () => {
  ...
  return (
    <section className="py-20 bg-honey" id="pain-points" lang={language === 'en' ? 'en' : 'es'}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {painPoints.map((point, index) => (
            <div 
              key={index}
              className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-primary/10"
            >
              <div className="mb-4 bg-honey p-3 rounded-lg inline-block">{point.icon}</div>
